...
const Home = () => {
    ...
    return (
        <div className={'main'}>
            <div className="row">
                <SpeedCard title={'Upload'} data={upload+'Mbps'}/>
                <SpeedCard title={'Download'} data={download+'Mbps'}/>
            ...
            {/* <div className="row">
                <Button onClick={()=>handleSpeedTest()} color={'primary'} variant="contained">SpeedTest</Button>
            </div> */}
            <div className="row">
